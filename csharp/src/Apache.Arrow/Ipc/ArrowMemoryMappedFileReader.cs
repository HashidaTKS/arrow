...
namespace Apache.Arrow.Ipc
{
    ...
    /// </summary>
    public class ArrowMemoryMappedFileReader : ArrowMemoryMappedViewStreamReader
    {
        private ArrowMemoryMappedFileReaderImplementation Implementation =>
            (ArrowMemoryMappedFileReaderImplementation)_implementation;

        public bool IsFileValid => Implementation.IsFileValid;

        public ArrowMemoryMappedFileReader(Stream stream)
            : base(stream)
        {
        }
