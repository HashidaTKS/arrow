...
{
    internal sealed class ArrowMemoryMappedFileReaderImplementation : ArrowMemoryMappedViewStreamReaderImplementation
    {
        ...
        public ArrowMemoryMappedFileReaderImplementation(Stream stream)
            : base(stream)
        {
        }
